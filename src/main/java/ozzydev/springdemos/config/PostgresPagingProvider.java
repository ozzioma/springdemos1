...
//import java.util.*;
//
//public class PostgresPagingProvider implements JPAODataPagingProvider
//{
//
//    private static final int DEFAULT_BUFFER_SIZE = 100;
//    private final Map<String, Integer> maxPageSizes;
//    private final Map<String, PostgresPagingProvider.CacheEntry> pageCache;
//    private final int cacheSize;
//    private final Queue<String> index;
//
//    public PostgresPagingProvider(Map<String, Integer> pageSizes)
//    {
//        this(pageSizes, DEFAULT_BUFFER_SIZE);
//    }
//
//    public PostgresPagingProvider(Map<String, Integer> pageSizes, final int bufferSize)
//    {
...
//    {
//        final PostgresPagingProvider.CacheEntry privousePage = pageCache.get(skiptoken.replaceAll("'", ""));
...
//
//        pageCache.put((String) page.getSkiptoken(), new PostgresPagingProvider.CacheEntry(count, page));
