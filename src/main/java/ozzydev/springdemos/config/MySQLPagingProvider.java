...
//import java.util.*;
//
//public class MySQLPagingProvider implements JPAODataPagingProvider
//{
//
//    private static final int DEFAULT_BUFFER_SIZE = 100;
//    private final Map<String, Integer> maxPageSizes;
//    private final Map<String, MySQLPagingProvider.CacheEntry> pageCache;
//    private final int cacheSize;
//    private final Queue<String> index;
//
//    public MySQLPagingProvider(Map<String, Integer> pageSizes)
//    {
//        this(pageSizes, DEFAULT_BUFFER_SIZE);
//    }
//
//    public MySQLPagingProvider(Map<String, Integer> pageSizes, final int bufferSize)
//    {
...
//    {
//        final MySQLPagingProvider.CacheEntry privousePage = pageCache.get(skiptoken.replaceAll("'", ""));
...
//
//        pageCache.put((String) page.getSkiptoken(), new MySQLPagingProvider.CacheEntry(count, page));
