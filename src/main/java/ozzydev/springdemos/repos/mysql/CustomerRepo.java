...
import ozzydev.springdemos.query.CustomSpecificationHandler;

import java.util.List;
import java.util.stream.Stream;

@Repository
public interface CustomerRepo extends JpaRepository<DemoCustomer, Long>, CustomSpecificationHandler<DemoCustomer>
{
